...
public class Examples {
    ...
    private void printAll() {
        ...
        Query<Person> selectAllQuery = session.createQuery("from com.sda.jpa.entity.Person", Person.class);
    ...
    private void update() {
        ...
        System.out.println("\t1)" + foundPerson);

        foundPerson.setName(foundPerson.getName() + "-updated");
